const generateLastProperty = (employee) => {
    if (employee.getRole() == "Manager") {
      return ` <div class="card-header">Office number: ${employee.officeNumber}</div>`;
    } else if (employee.getRole() == "Engineer") {
      return ` <div class="card-header">Github: ${employee.github}</div>`;
    } else if (employee.getRole() == "Intern") {
      return ` <div class="card-header">School: ${employee.school}</div>`;
    }
}
